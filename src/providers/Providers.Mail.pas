...
uses
  System.Classes, System.SysUtils, System.Variants, IdSMTP, IdSSLOpenSSL, IdMessage, IdMessageParts, IdText,
  IdAttachmentFile, IdExplicitTLSClientServerBase, Providers.Mail.Intf;

type
  IMail = Providers.Mail.Intf.IMail;
...
begin
  ...
  try
    ...
    begin
      Self.Disconnect;
      raise Exception.Create('Erro de autenticação:' + E.Message);
    end;
  end;
end;
